class Word:
    def __init__(self, i_WordNum, i_WordFolderPath, i_WordFilePath):
        ...
        #passing file path instead of the file itself
        self.__m_LetterCropper = CropperFactory.CreateCropper(eCropperFactoryContext.CreateLetterCropper, self.__m_WordFilePath, self.__m_WordFolderPath)
